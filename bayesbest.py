...
class Bayes_Classifier:
    ...
    def classify(self, sText):
        ...
        new = sText.lower()
        removenumber = re.sub(r'\d+','',new)
        nopunct= re.sub(r'[^\w\s]','',removenumber)
        nowhitespace = nopunct.strip()
        tokenized = self.tokenize(nowhitespace)
        for j in tokenized:
